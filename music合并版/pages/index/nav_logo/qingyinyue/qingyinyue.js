// pages/index/nav_logo/qingyinyue/qingyinyue.js
Page({
  data:{},
    onLoad: function () {
    var that = this;
    wx.request({
      url: 'http://route.showapi.com/213-1?showapi_appid=28882&showapi_sign=de117735a0454184a7d5b4253e286842&keyword=轻音乐&page=1', 
      data: {
      },
      header: {
  ...
  playTap: function (e) {
    ...
    wx.navigateTo({
      url: `../../../play/play?id=`+dataset.id+'&singkey=轻音乐' //跳转到播放页面并把歌id传过去
    })
