...
Page({
  data:{},
    ...
    var that = this;
    wx.request({
      url: 'http://route.showapi.com/213-1?showapi_appid=28882&showapi_sign=de117735a0454184a7d5b4253e286842&keyword=摇篮曲&page=1', 
      data: {
      },
      header: {
  ...
  playTap: function (e) {
    ...
    wx.navigateTo({
      url: `../../../play/play?id=`+dataset.id+'&singkey=摇篮曲' //跳转到播放页面并把歌id传过去
    })
